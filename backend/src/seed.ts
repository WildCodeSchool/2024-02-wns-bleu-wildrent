...
const seedDatabase = async () => {
  ...
  const articles = [
    ...
    { product: savedProducts[4] },
    { product: savedProducts[5] },
    { product: savedProducts[6] },
    { product: savedProducts[7] },
    { product: savedProducts[8] },
    { product: savedProducts[9] },
    { product: savedProducts[10] },
    { product: savedProducts[11] },
    { product: savedProducts[12] },
    { product: savedProducts[13] },
    { product: savedProducts[14] },
    { product: savedProducts[15] },
    { product: savedProducts[16] },
    { product: savedProducts[17] },
